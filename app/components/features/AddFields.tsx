...
import {Section, SectionDescription, SectionHeader, SectionNumber} from "~/components/ui/section";
    ...
    return (
        <>
            ...
            <Form method={"post"}>
                <ClientOnly>
                    {() => <>
                        <input name={"jsonData"} value={JSON.stringify({
                        ...
                        <div className={"w-full flex justify-center"}>
                            <div className={"flex gap-2 items-center"}>
                                ...
                                <Input className={"w-[100px]"}
                                       name={"numberOfRows"}
                                       placeholder={"How many rows to generate?"}></Input>
                                <Label>rows</Label>
                            </div>
                        </div>
                        <div className={"flex flex-col mt-4 w-full items-center gap-2"}>
                            <Button className={"w-[200px]"}>Generate</Button>
                            <Button onClick={() => clear()} variant={"outline"} size={"sm"} type={"button"}
